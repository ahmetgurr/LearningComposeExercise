...
fun UnitConverter() {
    ...
    Column(
        ...
        Text(text = "Unit Converter", modifier = Modifier.padding(16.dp), style = MaterialTheme.typography.headlineLarge)
        OutlinedTextField(
            value = inputValue,
            onValueChange = {
            inputValue = it
        ...
        Spacer(modifier = Modifier.height(16.dp))
        Text("Result : $outputValue $outputUnit ", modifier = Modifier.padding(16.dp),
