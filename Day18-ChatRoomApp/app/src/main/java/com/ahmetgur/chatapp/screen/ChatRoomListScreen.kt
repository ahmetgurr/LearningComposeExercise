package com.ahmetgur.chatapp.screen
...
import com.ahmetgur.chatapp.viewmodel.RoomViewModel
...
fun ChatRoomListScreen(
    ...
    //observeAsState: LiveData'nın değeri değiştiğinde, bu durumu otomatik olarak günceller.
    ...
    Column(
        ...
        // Display a list of chat rooms / Sohbet odalarının listesini görüntüle
        LazyColumn {
            items(rooms) { room ->
